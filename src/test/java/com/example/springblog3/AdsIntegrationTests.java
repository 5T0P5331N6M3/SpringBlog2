...
@SpringBootTest(classes = SpringBlog3ApplicationTests.class)
...
public class AdsIntegrationTests {
    ...
    // allows Java to make requests to test out CRUD
    @Autowired
    private MockMvc mvc;
    ...
    public void testAdsIndex() throws Exception {
        ...
        // Makes a Get request to /ads and verifies that we get some of the
        // static text of the ads/index.html template and at least the title
        // from the first Ad is present in the template.
    ...
    public void testDeleteAd() throws Exception {
        ...
        Ad existingAd = adDao.findByTitle("ad to be deleted");
